  ...
  return (
    <div className="flex flex-col gap-6 text-slate-100">
      <div>
        ...
        <h1 className="text-xl font-semibold text-slate-50">Control Panel</h1>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {links.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="rounded-xl border border-white/10 bg-slate-900/70 p-4 shadow-lg shadow-black/40 transition hover:border-white/20 hover:bg-slate-900"
          >
